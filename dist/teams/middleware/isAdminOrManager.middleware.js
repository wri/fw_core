...
exports.IsAdminOrManagerMiddleware = void 0;
...
let IsAdminOrManagerMiddleware = class IsAdminOrManagerMiddleware {
    ...
    use(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (teamMember &&
                (teamMember.role === teamMember_schema_1.EMemberRole.Administrator || teamMember.role === teamMember_schema_1.EMemberRole.Manager)) {
                yield next();
            }
            else
...
IsAdminOrManagerMiddleware = __decorate([
    ...
    __metadata("design:paramtypes", [teamMembers_service_1.TeamMembersService,
        mongoose_2.Model,
        mongoose_2.Model])
], IsAdminOrManagerMiddleware);
exports.IsAdminOrManagerMiddleware = IsAdminOrManagerMiddleware;
;
//# sourceMappingURL=isAdminOrManager.middleware.js.map